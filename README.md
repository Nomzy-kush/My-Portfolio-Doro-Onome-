...
The code in this repository is released under the [MIT](https://github.com/Nomzy-kush/My-Portfolio-Doro-Onome-/blob/main/MIT.md) License, which grants you the freedom to use, modify, and distribute the template as your own. However, if you choose to use the site's design largely unmodified, kindly credit me as the original designer of the site.
...
- [Download the ZIP file from this location](https://github.com/Nomzy-kush/My-Portfolio-Doro-Onome-/archive/refs/heads/main.zip) or run the following [git](https://git-scm.com/) command to clone the files to your machine:

```
git clone https://github.com/Nomzy-kush/My-Portfolio-Doro-Onome-.git
```
...
- GitHub: [@Nomzy-kush](https://github.com/Nomzy-kush)
- LinkedIn: [Doro Onome](https://www.linkedin.com/in/doro-onome-193205208/)
